        ...
        if (cardComponent != null && cardDragHandler != null)
        {
            ...
            switch (cardComponent.GetComponent<DragOperator>().DragAction)
            {
                ...
                case DragAction.UseAndDiscard:
                    var discardGroup = GroupRegistry.Instance?.Get(GroupName.Discard, PhaseManager.Instance == null ? null : (int?)PhaseManager.Instance.PlayerIndex);
                ...
                case DragAction.UseOnTargetAndDiscard:
                    var discardGroup1 = GroupRegistry.Instance?.Get(GroupName.Discard, PhaseManager.Instance == null ? null : (int?)PhaseManager.Instance.PlayerIndex);
