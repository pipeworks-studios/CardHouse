...
- Duplicate a sample game and start modifying it under CardHouse/SampleGames/
- Duplicate the "Card Table" scene and start modifying it under CardHouse/CardHouseCore/Scenes/
- Create a new scene, throw the "System" prefab in, and drag in the card groups you'll need from the Prefabs folder. Most of what you'll need to set up a game's rules can be hooked up with CardTransferOperators and the PhaseManager.
